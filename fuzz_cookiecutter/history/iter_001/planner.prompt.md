...
- case_000: WARNING mode=cli exception=SystemExit phase=render_path
- case_002: WARNING mode=cli exception=SystemExit phase=hook_script_render
- case_003: WARNING mode=api exception=NonTemplatedInputDirException phase=generate_files
- case_004: WARNING mode=cli exception=SystemExit phase=render_file
- case_005: WARNING mode=cli exception=NonTemplatedInputDirException phase=generate_files

## Coverage Data

Coverage totals: 750/1101 lines, 140/294 branches, 63.80% overall.

## Missing-Line Hotspots

Top hotspots:
- cookiecutter/generate.py: 68 missing lines (52, 72, 76, 77, 78, 79, 82, 83)
...
- cookiecutter/prompt.py: 47 missing lines (56, 57, 58, 88, 101, 146, 147, 148)
...
cookiecutter/prompt.py:56
55:             return True
56:         if value in self.no_choices:
57:             return False

cookiecutter/prompt.py:57
56:         if value in self.no_choices:
57:             return False
58:         raise InvalidResponse(self.validate_error_message)

cookiecutter/prompt.py:58
57:             return False
58:         raise InvalidResponse(self.validate_error_message)
59: 
