...
- case_000: WARNING mode=json exception=UndefinedVariableInTemplate phase=n/a
- case_001: WARNING mode=cli exception=NonTemplatedInputDirException phase=n/a
- case_002: WARNING mode=cli exception=NonTemplatedInputDirException phase=n/a
- case_003: WARNING mode=cli exception=SystemExit phase=n/a
- case_008: WARNING mode=cli exception=SystemExit phase=n/a

## Coverage Data

Coverage totals: 701/1101 lines, 126/294 branches, 59.28% overall.

## Missing-Line Hotspots

Top hotspots:
- cookiecutter/generate.py: 77 missing lines (51, 52, 56, 72, 76, 77, 78, 79)
- cookiecutter/prompt.py: 74 missing lines (31, 37, 38, 39, 40, 42, 53, 54)
